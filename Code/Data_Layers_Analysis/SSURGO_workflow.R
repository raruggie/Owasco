...
# derived from the SSURGO database download

# Its just really average percent clay and silt. 
...
####################### Workflow to process SSURGO data #######################
...
soil <- get_ssurgo(template = df$geometry[i],label = site)

save(soil, 'C:/PhD/Research/TP_Regression_data/Otsquago_Creek_Soils.Rdata')
